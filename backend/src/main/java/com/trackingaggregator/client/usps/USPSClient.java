...
public class USPSClient implements CourierClient {
    ...
    public Optional<TrackingResult> track(String trackingNumber) {
        try {
            ...
            throw CourierApiException.fromWebApplicationException(Courier.USPS, trackingNumber, e);
        } catch (ProcessingException e) {
            throw CourierApiException.fromTransportFailure(Courier.USPS, trackingNumber, e);
        }
    }
}
